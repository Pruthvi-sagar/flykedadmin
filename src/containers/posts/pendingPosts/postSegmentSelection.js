      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} style={{ marginTop: '10px', marginBottom: '10px' }}>
            <Grid onClick={() => handleUpdateData(postFullDetails?._id, { segmentType: null  })} item md={12} xs={12} style={{ marginTop: '5px', marginBottom: '5px', cursor: 'pointer', borderRadius:'2px', position: 'relative', display: selectedType === null ? 'none' : '' }}>
                <Grid container spacing={2} justifyContent="space-between" alignItems="center" style={{ padding: '8px' }}>
                    <Grid container spacing={2} direction='row' justifyContent="flex-start" alignItems="center" style={{ padding: '8px' }}>
                      <Typography style={{ color:'#172849',  font: "normal normal 14px/17px 'SF Pro Rounded', sans-serif" }}>Remove selection</Typography>
                    </Grid>
                  </Grid>
                </Grid>
