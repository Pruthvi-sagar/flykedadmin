...
export default function PublishedPosts() {
  ...
  return (
    ...
    >
      {didYouKnow && 
      <did style={{display: 'flex', cursor: 'pointer', justifyContent: 'flex-end', marginBottom: 10}} onClick={() => setShowLongReads(true)}>
       <Typography
                gutterBottom
                variant="body1"
      ...
      {showLongReads && <LongReads open={showLongReads} resetLongReads={resetLongReads} onClose={() => setShowLongReads(false)} data={didYouKnow} />}
    </MainContainer>
  )
}
