...
const ImageCropColorPalletModel = ({
  openCropModel, selectedImage, setSelectedImage, closePalletModel, handleStep1Back, postDetails, handleUpdateData, sliderIndex
}) => {
    ...
    if (cropedImage && currentStep === 1) {
     ...
     if (fileData) {
       ...
       data= {
         ...
         coverImage: {
         image: fileData,
         shortTitle: postDetails?.coverImage?.shortTitle || ''
          }
        }  
       }
       else {
